...
// Import the additional states
import LevelCenterState from './states/LevelCenter'
import CozyTestLevelState from './states/CozyTest'
import ChrisTestLevelState from './states/ChrisTest'
import StartScreenState from './states/Start'
import CreditScreenState from './states/CreditScreen'
import ControlScreenState from './states/ControlScreen'
...
class Game extends Phaser.Game {
  ...
  constructor () {
    ...
    this.state.add('Level01', LevelCenterState, false)
    this.state.add('TestLevel', TestLevelState, false)
    this.state.add('CozyTest', CozyTestLevelState, false)
    this.state.add('ChrisTest', ChrisTestLevelState, false)
    this.state.add('StartScreen', StartScreenState, false)
    this.state.add('CreditScreen', CreditScreenState, false)
    this.state.add('ControlScreen', ControlScreenState, false)
